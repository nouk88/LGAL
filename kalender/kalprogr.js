...
this.DagNaam = new Array( "maandag", "dinsdag", "woensdag", "donderdag", "vrijdag", "zaterdag", "zondag" );
...
maakHTML = "<table"+ " align=center"+ " width='" + ((this.celbreedte) * 7) + "'"+ " border='1'"+ " bordercolor='" + this.RandKleur + "'"+ " bordercolordark='" + this.RandKleur + "'"+ " bordercolorlight='" + this.RandKleur + "'"+ " cellspacing=0"+ " >" + this.r;maakOutput = maakOutput + maakHTML;
...
maakHTML = "<table align=center"+ " bgColor=" + this.TabelKleur+ " border='0'"+ " bordercolor='" + this.RandKleur + "'"+ " bordercolordark='" + this.RandKleur + "'"+ " bordercolorlight='" + this.RandKleur + "'"+ " width='" + (this.celbreedte * 7) + "'"+ " cellspacing=0"+ " cellpadding=3"+ " >";
maakOutput = maakOutput + maakHTML + this.r + this.r;
maakOutput = maakOutput + "<tr>" + this.r;
for (nCol=0; nCol<7; nCol++) {maakHTML = "<td align=center"+ " width=" + nWidth+ " bgcolor=" + this.TitelAgKleur+ " nowrap "+ " >"+ jsFontStr( this.TitelTekstType, this.TitelTekstGrootte, this.TitelTekstKleur )+ " <b><center>" + this.DagNaam[nCol]+ " </center></b></font></td>";
